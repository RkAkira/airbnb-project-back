...
public class Booking extends AbstractAuditingEntity<Long> {
    ...
    public int getNbOfTravelers() {
        return nbOfTravelers;
    }

    public void setNbOfTravelers(int nbOfTravelers) {
        this.nbOfTravelers = nbOfTravelers;
    }
    ...
    public boolean equals(Object o) {
        ...
        return totalPrice == booking.totalPrice && nbOfTravelers == booking.nbOfTravelers && Objects.equals(startDate, booking.startDate) && Objects.equals(endDate, booking.endDate) && Objects.equals(fkTenant, booking.fkTenant) && Objects.equals(fkListing, booking.fkListing);
    }

    @Override
    public int hashCode() {
        return Objects.hash(startDate, endDate, totalPrice, nbOfTravelers, fkTenant, fkListing);
    }
